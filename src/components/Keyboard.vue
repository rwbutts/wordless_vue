<template>
     ...
     <div class='keyboard' >
          ...
          <div class='kb-row' >
               <key char='DELETE' ref='DELETE_KEY' :controlKey="true" label='DELETE'/>
               ...
               <key char='ENTER' ref='ENTER_KEY'   :controlKey="true" label='ENTER'/>
         </div>
         <div class='kb-row' >
               <key  ref='RESET_KEY' char='RESET'  :controlKey="true" label='PLAY AGAIN' @click="broadcastReload();" />
         </div>
     </div>
